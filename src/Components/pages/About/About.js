   ...
   return (
      <div id="about">
         <div className=" about">
            ...
            <div className="p-5">
               <h3>About Us</h3>
               <p><b>Positive relationship:</b>We Maintain a positive relationship with our tourists. The administrators creates a harmonious leaning environment. </p>
               ...
               <p><b>Tourists as a responsible :</b> Our guide have passionate about her profession. They always carry out their responsibilities as an educator in the true sense of the word, going beyond merely imparting knowledge in the classroom.</p>
